...
## Country, Ladder Score (Happiness score), and the six contributing factors:
...
## Standardize column names using 'snake_case' for easier 
## manipulation and cleaner referencing
...
spotify_2025_R <- universal_spotify |>
                    ...
                    mutate(artist = word(artists, 1, sep = ",")) |>
                    select(-artists) |>
                    relocate(artist, .after = title)   ## Only need to move the artist column
...
new_zealand_2025_matched_r_cleaned <- new_zealand_2025_matched_r |>
                                        distinct(Artist, Title, .keep_all = TRUE) |>  ## Preserve columns of audio features
...
ggplot(data = top_happiness_countries_23_corr_melt, aes(x = Var1, y = Var2, fill = value)) +
  ...
  scale_fill_gradient2(low = "red", 
                       ...
                       name = "Correlation") +
  theme_minimal() +    ## Remove borders and unnecessary tick marks
